...
```groovy
dependencies {
    compile 'com.github.proxer:ProxerLibJava:4.1.0'
}
```

You can also download the `jar` directly from [here](https://jitpack.io/com/github/proxer/ProxerLibJava/4.1.0/ProxerLibJava-4.1.0.jar), if you prefer.
...
You can find detailed JavaDoc [here](https://jitpack.io/com/github/proxer/ProxerLibJava/4.1.0/javadoc/).
