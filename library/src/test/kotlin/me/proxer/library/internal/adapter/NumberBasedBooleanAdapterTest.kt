...
class NumberBasedBooleanAdapterTest {
    ...
    fun testFromBoolean() {
        ...
        result.exceptionMessage shouldBeEqualTo "Expected a number, string or null but was BOOLEAN at path $"
    }
    ...
    fun testFromIntInvalid() {
        ...
        result.exceptionMessage shouldBeEqualTo "Expected a 1 or 0 but was 3 at path $"
    }
    ...
    fun testFromStringInvalid() {
        ...
        result.exceptionMessage shouldBeEqualTo "Expected a true or false but was invalid at path $"
    }
    ...
    fun testFromInvalid() {
        ...
        result.exceptionMessage shouldBeEqualTo "Expected a number, string or null but was BEGIN_ARRAY at path $"
    }

    @Test
    fun testToJson() {
        adapter.toJson(true) shouldBeEqualTo "1"
    }

    @Test
    fun testToJsonFalse() {
        adapter.toJson(false) shouldBeEqualTo "0"
    }
