...
class DelimitedEnumSetAdapterFactoryTest {
    ...
    fun testToJsonSingle() {
        val testSubject = GenderTestClass(EnumSet.of(Gender.FEMALE))
    ...
    fun testToJsonMultiple() {
        val testSubject = GenderTestClass(EnumSet.of(Gender.FEMALE, Gender.MALE))
        val result = moshi.adapter(GenderTestClass::class.java).toJson(testSubject)
    ...
    fun testToJsonMultipleDifferentDelimiter() {
        val testSubject = GenderWithDelimiterTestClass(EnumSet.of(Gender.FEMALE, Gender.MALE))
